...
const Signup = () => {
  ...
  return (
    <VStack spacing="5px">
      <FormControl id="first-name" isRequired color="gray.50">
      ...
      <FormControl id="email" isRequired color="gray.50">
      ...
      <FormControl id="password" isRequired color="gray.50">
      ...
      <FormControl id="pic" color="gray.50">
        <FormLabel color="grey">Upload your Picture</FormLabel>
        <Input
          type="file"
          p={1.5}
          accept="image/*"
